...
$("body").on("click", ".init-experience", function() {
  showStepOne();
  $(".calculator").fadeIn();
...
$("body").on("click", ".produtos-category.solteiro", function() {
  window.open("https://loja.colchoa.com.br/solteiro/", "_blank");
});

$("body").on("click", ".produtos-category.solteirao", function() {
  window.open("https://loja.colchoa.com.br/solteirao/", "_blank");
});

$("body").on("click", ".produtos-category.viuva", function() {
  window.open("https://loja.colchoa.com.br/viuva/", "_blank");
});

$("body").on("click", ".produtos-category.casal", function() {
  window.open("https://loja.colchoa.com.br/casal/", "_blank");
});

$("body").on("click", ".produtos-category.queen", function() {
  window.open("https://loja.colchoa.com.br/queen/", "_blank");
});

$("body").on("click", ".produtos-category.king", function() {
  window.open("https://loja.colchoa.com.br/king/", "_blank");
});
